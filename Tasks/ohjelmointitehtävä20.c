...
scanf("%lf", &luku1);
    ...
    for(laskuri = 0; luku1 >= luku2; laskuri = laskuri + 1){
...
(Kokeile myös miten ohjelma käyttäytyy, kun "unohdat" tietojen lukemisessa &-merkin muuttujan nimen edestä.) Toteuta ohjelma for rakenteella.
*/